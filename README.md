...
![Build Status](https://github.com/letyshub/SharpCards/actions/workflows/dotnet.yml/badge.svg)
...
2.  Clone the repository:
    ```bash
    git clone [https://github.com/letyshub/SharpCards.git](https://github.com/letyshub/SharpCards.git)
    cd Sharp Cards
    ```
3.  Run the application:
    ```bash
    dotnet run --project src/SharpCards.csproj
    ```
